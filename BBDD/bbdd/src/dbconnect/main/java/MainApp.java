	...
	public static void main(String[] args) {
		...
		do{
			...
			case 6:
				...
				int idP = c.hacerInsertPedido(status,codigo, id_cliente);
				if(idP!=-1) {
				...
				break;
			case 7:
				String cod, nombreProducto, idCliente, cantidad, precio;
				...
				System.out.print("Introduzca el idCliente: "); idCliente=sc.nextLine();
				System.out.print("Introduzca la cantidad: "); cantidad=sc.nextLine(); 
				System.out.print("Introduzca el precio: "); precio=sc.nextLine(); 

				int idL = c.hacerInsertLinea(cod, nombreProducto, idCliente, cantidad, precio);
				if(idL!=-1) {
